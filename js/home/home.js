...
//个人简介 
function brief(){
	str='4C69 00后一枚，活跃在各个技术社区，常以4C69作为昵称，这是我的个人博客。';
...
function idea(){
	...
	str='我是从高二开始接触Web应用开发技术，一个小白怎么能没有一个属于自己的网站呢！博主在WEB道路上的点点滴滴，愿与你们共同分享，一起进步！';
	$("#idea .ban .ban-l").eq(2).find("p").text(str);
}
//梦想 
function dream(){
	str='“ 20岁~30岁 写代码，朝着牛逼的方向努力。30岁~40岁 开一家数据恢复公司，增加储蓄。40岁~50岁 出去游历，看到更大的世界。50岁~60岁 为自己写一本书，自己的故事。总之我现在所做的一切，都是为了追求更加完美。”';
